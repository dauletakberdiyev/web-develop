<html>
    <head><style>
        .cards{
            display:flex;flex-wrap:wrap;width:700px;margin-left:auto;margin-right:auto;
        }
        .cards .card{
            width:300px;border:1px solid red;border-radius:5px;display:flex;margin:10px;
        }
        .menu {
            display:block;width:700px;margin-left:auto;margin-right:auto;
        }
        .card .title{
    ...
    <body>
        <div class="cards">
            ...
            <div class="menu">
            <a href="task93.php">Home</a> | <a href="task93.php?maker=Toyota">Toyota</a> | <a href="task93.php?maker=BMW">BMW</a> | <a href="task93.php?maker=Audi">Audi</a> | <a href="task93.php?maker=Lada">Lada</a>
        </div>
        <div class="menu">
